...
<div class="container">
	<form:form  modelAttribute="userForm" name="userForm" class="form-signin" onsubmit="return userFormValidate()" method="POST">
		<h2 class="form-signin-heading">
			<spring:message code="label.user.newUserTitle" />
		</h2>
		<spring:message code="label.vorname" var="labelVorname"/>
		 <spring:bind path="vorname">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="vorname" name="vorname" id="vorname" maxlength="20"  required="required" class="form-control" placeholder="${labelVorname}" ></form:input>
		...
		<spring:message code="label.nachname" var="labelNachname"/>
		<spring:bind path="nachname">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" name="nachname" id="nachname" path="nachname" maxlength="20" class="form-control" placeholder="${labelNachname}"  required="required"></form:input>
		...
		<spring:bind path="username">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" id="username" name="username" path="username" minlength="6" maxlength="10" class="form-control" required="required" placeholder="${labelUsername}"></form:input>
		...
		<spring:bind path="email">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" id="email" path="email" name="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2, 4}$"  required="required" placeholder="${labelEmail}" ></form:input>
